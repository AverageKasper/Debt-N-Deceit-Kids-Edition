...
const close_gambling = document.getElementById('close-gambling');
const gambling_modal2 = document.getElementById('gambling-modal');
const close_hilo = document.querySelector('.close-hilo');
const close_snake = document.querySelector('.close-snake-eyes');
const close_horse = document.querySelector('.close-horse-race');
const close_blackjack = document.querySelector('.close-blackjack');
...
function showGame(gameId) {
    let gambling_game_modal = document.getElementById(gameId);
    gambling_game_modal.style.display = 'block';

}

function hideGame(gameId) {
    let gambling_game_modal = document.getElementById(gameId);
    gambling_game_modal.style.display = 'none';
}
...
function initSnakeEyes() {
    document.getElementById('snake-eyes-container').innerHTML = `
        <button id="snake-eyes-play" class="button">Roll Dice</button>
...
function initHiLo() {
    document.getElementById('hilo-container').innerHTML = `
        ...
        <div id="hilo-guess" style="display: none;">
            <button id="hilo-hi" class="button">Guess Hi</button>
            <button id="hilo-lo" class="button">Guess Lo</button>
        </div>
...
function initHorseRace() {
    document.getElementById('horse-race-container').innerHTML = `
        <button id="horse-race-start" class="button">Start Horse Race</button>
        ...
        <div id="horse-selection" style="display: none;">
            ...
            <button id="place-bet" class="button">Place Bet</button>
        </div>
...
function initBlackjack() {
    ...
    document.getElementById('blackjack-container').innerHTML = `
        <button id="blackjack-start" class="button">Start Blackjack</button>
        <div id="blackjack-result"></div>
        <div id="blackjack-actions" style="display: none;">
            <button id="blackjack-hit" class="button">Hit</button>
            <button id="blackjack-stand" class="button">Stand</button>
        </div>
    `;
...
close_gambling.addEventListener('click', () => {
    gambling_modal2.style.display = 'none';
    update_stats();
});

close_hilo.addEventListener('click', () => {
    hideGame('hilo');
    update_stats();
});

close_snake.addEventListener('click', () => {
    hideGame('snake-eyes');
    update_stats();
});
close_blackjack.addEventListener('click', () => {
    hideGame('blackjack');
    update_stats();
});
close_horse.addEventListener('click', () => {
    hideGame('horse-race');
    update_stats();
});